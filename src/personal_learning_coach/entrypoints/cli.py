...
from personal_learning_coach.infrastructure.monitoring import configure_logging
...
def _cmd_assess(args: argparse.Namespace) -> None:
    from personal_learning_coach.application.assessment.level_tester import run_assessment
    ...
    if args.answers:
        ...
        from personal_learning_coach.application.assessment.level_tester import generate_assessment_questions
...
def _cmd_plan(args: argparse.Namespace) -> None:
    ...
    from personal_learning_coach.application.learning.plan_generator import enroll_domain
...
def _cmd_submit(args: argparse.Namespace) -> None:
    ...
    from personal_learning_coach.domain.models import SubmissionRecord, TopicStatus
...
def _cmd_report(args: argparse.Namespace) -> None:
    from personal_learning_coach.application.learning.report_generator import save_report
...
def _cmd_pause(args: argparse.Namespace) -> None:
    from personal_learning_coach.infrastructure import data_store
    from personal_learning_coach.domain.models import DomainEnrollment, DomainStatus
...
def _cmd_delete_domain(args: argparse.Namespace) -> None:
    from personal_learning_coach.entrypoints.api.routes.domains import _delete_records_for_domain
    from personal_learning_coach.infrastructure import data_store
    from personal_learning_coach.domain.models import DomainEnrollment
...
def _cmd_final_assessment(args: argparse.Namespace) -> None:
    from personal_learning_coach.application.learning.mastery_engine import submit_final_assessment
...
def _cmd_backup(args: argparse.Namespace) -> None:
    from personal_learning_coach.infrastructure.backup_service import create_backup
...
def _cmd_restore(args: argparse.Namespace) -> None:
    from personal_learning_coach.infrastructure.backup_service import restore_backup
