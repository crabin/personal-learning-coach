...
from personal_learning_coach.domain.models import UserProfile
...
def get_report(
    ...
    from personal_learning_coach.application.learning.report_generator import generate_report_payload
