...
from personal_learning_coach.entrypoints.api.routes import admin, auth, domains, reports, schedules, submissions
from personal_learning_coach.infrastructure.config import load_config
from personal_learning_coach.infrastructure.monitoring import configure_logging, record_runtime_event
from personal_learning_coach.infrastructure.security import seed_admin_from_environment
...
def serve() -> None:
    config = load_config()
    uvicorn.run(
        "personal_learning_coach.entrypoints.api.main:app",
